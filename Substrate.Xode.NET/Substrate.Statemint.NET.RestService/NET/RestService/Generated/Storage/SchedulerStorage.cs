...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 GetAgenda(string key);
        
        /// <summary>
        /// >> Retries
        ///  Retry configurations for items to be executed, indexed by task address.
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetRetries(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> _agendaTypedStorage;
        
        /// <summary>
        /// _retriesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig> _retriesTypedStorage;
        ...
        public SchedulerStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AgendaTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28>("Scheduler.Agenda", storageDataProvider, storageChangeDelegates);
            this.RetriesTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig>("Scheduler.Retries", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> AgendaTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig> RetriesTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 result))
            {
                return result;
            }
            else
        ...
        ///  Retry configurations for items to be executed, indexed by task address.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetRetries(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RetriesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result))
            {
                return result;
            }
            else
