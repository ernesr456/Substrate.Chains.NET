...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface IAssetConversionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo GetPools(string key);
    ...
    public sealed class AssetConversionStorage : IAssetConversionStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo> _poolsTypedStorage;
        ...
        {
            this.PoolsTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo>("AssetConversion.Pools", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo> PoolsTypedStorage
        {
            get
            {
        ...
        ///  created rather than people sending tokens directly to a pool's public account.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo GetPools(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PoolsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo result))
            {
                return result;
            }
            else
