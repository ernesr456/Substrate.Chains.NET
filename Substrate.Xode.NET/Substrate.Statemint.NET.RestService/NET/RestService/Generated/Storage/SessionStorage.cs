...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface ISessionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>> GetQueuedKeys();
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys GetNextKeys(string key);
    ...
    public sealed class SessionStorage : ISessionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>>> _queuedKeysTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys> _nextKeysTypedStorage;
        ...
        public SessionStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.NextKeysTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>("Session.NextKeys", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>>> QueuedKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys> NextKeysTypedStorage
        {
            get
            {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>> GetQueuedKeys()
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys GetNextKeys(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (NextKeysTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys result))
            {
                return result;
            }
            else
