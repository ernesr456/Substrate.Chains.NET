...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface IPolkadotXcmStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38 GetVersionDiscoveryQueue();
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40 GetLockedFungibles(string key);
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm();
    }
    ...
    public sealed class PolkadotXcmStorage : IPolkadotXcmStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38> _versionDiscoveryQueueTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40> _lockedFungiblesTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> _recordedXcmTypedStorage;
        ...
        public PolkadotXcmStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.VersionDiscoveryQueueTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38>("PolkadotXcm.VersionDiscoveryQueue", storageDataProvider, storageChangeDelegates);
            ...
            this.LockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40>("PolkadotXcm.LockedFungibles", storageDataProvider, storageChangeDelegates);
            ...
            this.RecordedXcmTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1>("PolkadotXcm.RecordedXcm", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38> VersionDiscoveryQueueTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40> LockedFungiblesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcmTypedStorage
        {
            get
            {
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38 GetVersionDiscoveryQueue()
        {
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40 GetLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40 result))
            {
                return result;
            }
            else
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm()
        {
