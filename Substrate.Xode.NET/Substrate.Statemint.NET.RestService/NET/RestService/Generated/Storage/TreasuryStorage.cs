...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key);
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetApprovals();
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key);
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9> _approvalsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> _spendsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegates);
            ...
            this.ApprovalsTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9>("Treasury.Approvals", storageDataProvider, storageChangeDelegates);
            ...
            this.SpendsTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus>("Treasury.Spends", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9> ApprovalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> SpendsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetApprovals()
        {
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SpendsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus result))
            {
                return result;
            }
            else
