...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
