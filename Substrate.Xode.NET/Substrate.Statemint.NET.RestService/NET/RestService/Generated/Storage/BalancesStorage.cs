...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 GetReserves(string key);
        
        /// <summary>
        /// >> Holds
        ///  Holds on account balances.
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 GetHolds(string key);
        
        /// <summary>
        /// >> Freezes
        ///  Freeze locks on account balances.
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 GetFreezes(string key);
    }
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30> _reservesTypedStorage;
        
        /// <summary>
        /// _holdsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31> _holdsTypedStorage;
        
        /// <summary>
        /// _freezesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32> _freezesTypedStorage;
        ...
        public BalancesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ReservesTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30>("Balances.Reserves", storageDataProvider, storageChangeDelegates);
            this.HoldsTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>("Balances.Holds", storageDataProvider, storageChangeDelegates);
            this.FreezesTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32>("Balances.Freezes", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30> ReservesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31> HoldsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32> FreezesTypedStorage
        {
            get
            {
        ...
        ///  Use of reserves is deprecated in favour of holds. See `https://github.com/paritytech/substrate/pull/12951/`
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 GetReserves(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReservesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 result))
            {
                return result;
            }
            else
        ...
        ///  Holds on account balances.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 GetHolds(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (HoldsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 result))
            {
                return result;
            }
            else
        ...
        ///  Freeze locks on account balances.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 GetFreezes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (FreezesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 result))
            {
                return result;
            }
            else
