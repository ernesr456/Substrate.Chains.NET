...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface ICollatorSelectionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetInvulnerables();
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35 GetCandidateList();
    ...
    public sealed class CollatorSelectionStorage : ICollatorSelectionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> _invulnerablesTypedStorage;
        
        /// <summary>
        /// _candidateListTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35> _candidateListTypedStorage;
        ...
        {
            this.InvulnerablesTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34>("CollatorSelection.Invulnerables", storageDataProvider, storageChangeDelegates);
            this.CandidateListTypedStorage = new TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35>("CollatorSelection.CandidateList", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> InvulnerablesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35> CandidateListTypedStorage
        {
            get
            {
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetInvulnerables()
        {
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35 GetCandidateList()
        {
