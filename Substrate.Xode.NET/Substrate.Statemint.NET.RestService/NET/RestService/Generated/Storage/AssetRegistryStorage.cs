...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface IAssetRegistryStorage : IStorage
    {
        ...
        /// >> AssetIdLocation
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location GetAssetIdLocation(string key);
    ...
    public sealed class AssetRegistryStorage : IAssetRegistryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> _assetIdLocationTypedStorage;
        ...
        {
            this.AssetIdLocationTypedStorage = new TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location>("AssetRegistry.AssetIdLocation", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> AssetIdLocationTypedStorage
        {
            get
            {
        ...
        /// >> AssetIdLocation
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location GetAssetIdLocation(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetIdLocationTypedStorage.Dictionary.TryGetValue(key, out Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location result))
            {
                return result;
            }
            else
