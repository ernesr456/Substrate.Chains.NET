    ...
    public sealed class TournamentAAAStorage
    {
        ...
        public TournamentAAAStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "TournamentSchedules"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentScheduledAction)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "Tournaments"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.TournamentConfig)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "ActiveTournaments"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "TournamentRankings"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "TournamentRewardClaims"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumRewardClaimState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "GoldenDucks"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumGoldenDuckState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TournamentAAA", "GoldenDuckRewardClaims"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumRewardClaimState)));
        }
        ...
        /// >> TournamentSchedules
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentScheduledAction> TournamentSchedules(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TournamentAAAStorage.TournamentSchedulesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentScheduledAction>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> TreasuryAccountsCache(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
        ...
        /// >> Tournaments
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.TournamentConfig> Tournaments(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = TournamentAAAStorage.TournamentsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.TournamentConfig>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> ActiveTournaments
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentState> ActiveTournaments(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
            string parameters = TournamentAAAStorage.ActiveTournamentsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumTournamentState>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> TournamentRankings
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52> TournamentRankings(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = TournamentAAAStorage.TournamentRankingsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52>(parameters, blockhash, token);
            return result;
        }
        ...
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumRewardClaimState> TournamentRewardClaims(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumRewardClaimState>(parameters, blockhash, token);
            return result;
        }
        ...
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumGoldenDuckState> GoldenDucks(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumGoldenDuckState>(parameters, blockhash, token);
            return result;
        }
