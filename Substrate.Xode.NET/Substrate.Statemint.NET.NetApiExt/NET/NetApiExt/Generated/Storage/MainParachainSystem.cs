...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        public ParachainSystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ValidationData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.PersistedValidationData)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "HostConfiguration"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "LastHrmpMqcHeads"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.BTreeMapT2)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpwardDeliveryFeeFactor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
        ...
        ///  in the pallet.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>> UnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  respect to relay chain constraints.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker> AggregatedUnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.AggregatedUnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  in the trie.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.PersistedValidationData> ValidationData(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ValidationDataParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.PersistedValidationData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.EnumUpgradeRestriction>> UpgradeRestrictionSignal(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeRestrictionSignalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.EnumUpgradeRestriction>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.EnumUpgradeGoAhead>> UpgradeGoAhead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeGoAheadParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.EnumUpgradeGoAhead>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof> RelayStateProof(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelayStateProofParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot> RelevantMessagingState(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelevantMessagingStateParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration> HostConfiguration(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HostConfigurationParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.AbridgedHostConfiguration>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain> LastDmqMqcHead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastDmqMqcHeadParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.BTreeMapT2> LastHrmpMqcHeads(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastHrmpMqcHeadsParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.BTreeMapT2>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This will be cleared in `on_initialize` of each new block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>> HrmpOutboundMessages(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HrmpOutboundMessagesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The factor to multiply the base delivery fee by for UMP.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> UpwardDeliveryFeeFactor(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpwardDeliveryFeeFactorParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedXcmpWeightOverride(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ReservedXcmpWeightOverrideParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight> ReservedDmpWeightOverride(string blockhash, CancellationToken token)
        {
    ...
    public sealed class ParachainSystemConstants
    {
        ...
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id SelfParaId()
        {
            var result = new Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id();
