...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SessionStorage
    {
        ...
        public SessionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys)));
        ...
        ///  The current set of validators.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> Validators(string blockhash, CancellationToken token)
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>>> QueuedKeys(string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.QueuedKeysParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys> NextKeys(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.SessionKeys keys, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> proof)
        {
