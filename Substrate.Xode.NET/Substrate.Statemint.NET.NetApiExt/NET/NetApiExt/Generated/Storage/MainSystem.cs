...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "AuthorizedUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.CodeUpgradeAuthorization)));
        }
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> BlockWeight(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHash(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHash(string blockhash, CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> Digest(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> Events(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>> EventTopics(Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhase(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  `Some` if a code upgrade has been authorized.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.CodeUpgradeAuthorization> AuthorizedUpgrade(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.AuthorizedUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_system.CodeUpgradeAuthorization>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class SystemCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AuthorizeUpgradeWithoutChecks(Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256 code_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(code_hash.Encode());
