...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetRegistryStorage
    {
        ...
        public AssetRegistryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "AssetIdLocation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "AssetLocationId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        }
        ...
        /// >> AssetIdLocation
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> AssetIdLocation(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.AssetIdLocationParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string AssetLocationIdParams(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location key)
        {
        ...
        /// >> AssetLocationId
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AssetLocationId(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AssetRegistryCalls
    {
        ...
        /// </summary>
        public static Method RegisterReserveAsset(Substrate.NetApi.Model.Types.Primitive.U32 asset_id, Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset_location)
        {
