...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Spends"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9> Approvals(string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ApprovalsParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> Spends(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.SpendsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method ProposeSpend(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> value, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SpendLocal(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Spend(Substrate.NetApi.Model.Types.Base.BaseTuple asset_kind, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 beneficiary, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> valid_from)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill ProposalBond()
        {
            var result = new Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
