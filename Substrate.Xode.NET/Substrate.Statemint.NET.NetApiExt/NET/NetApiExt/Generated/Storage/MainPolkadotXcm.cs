...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class PolkadotXcmStorage
    {
        ...
        public PolkadotXcmStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "SupportedVersion"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation>), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "VersionNotifiers"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation>), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "VersionNotifyTargets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "VersionDiscoveryQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "LockedFungibles"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "RecordedXcm"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1)));
        }
        ...
        ///  The ongoing queries.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> Queries(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.QueriesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  times this pair has been trapped (usually just 1 if it exists at all).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AssetTraps(Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string SupportedVersionParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key)
        {
        ...
        ///  The Latest versions that we know various locations support.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> SupportedVersion(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifiersParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key)
        {
        ...
        ///  All locations that we have requested version notifications from.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> VersionNotifiers(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifyTargetsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key)
        {
        ...
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>> VersionNotifyTargets(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38> VersionDiscoveryQueue(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.VersionDiscoveryQueueParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT38>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The current migration's stage, if any.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> CurrentMigration(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.CurrentMigrationParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage>(parameters, blockhash, token);
            return result;
        }
        ...
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord> RemoteLockedFungibles(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssetId> key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40> LockedFungibles(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.LockedFungiblesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT40>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public async Task<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcm(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.RecordedXcmParams();
            var result = await _client.GetStorageAsync<Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class PolkadotXcmCalls
    {
        ...
        /// </summary>
        public static Method Send(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation dest, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedXcm message)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceXcmVersion(Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location location, Substrate.NetApi.Model.Types.Primitive.U32 version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceSubscribeVersionNotify(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceUnsubscribeVersionNotify(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method LimitedReserveTransferAssets(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation dest, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation beneficiary, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssets assets, Substrate.NetApi.Model.Types.Primitive.U32 fee_asset_item, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.v3.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TransferAssets(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation dest, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation beneficiary, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssets assets, Substrate.NetApi.Model.Types.Primitive.U32 fee_asset_item, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.v3.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ClaimAssets(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssets assets, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(assets.Encode());
            byteArray.AddRange(beneficiary.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TransferAssetsUsingTypeAndThen(Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation dest, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssets assets, Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm_executor.traits.asset_transfer.EnumTransferType assets_transfer_type, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssetId remote_fees_id, Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm_executor.traits.asset_transfer.EnumTransferType fees_transfer_type, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedXcm custom_xcm_on_dest, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.v3.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(assets.Encode());
