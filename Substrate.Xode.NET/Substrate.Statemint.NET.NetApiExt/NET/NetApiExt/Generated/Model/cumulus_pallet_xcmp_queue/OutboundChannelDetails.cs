...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id Recipient { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State { get; set; }
        /// <summary>
        /// >> signals_exist
        /// </summary>
        ...
        {
            var start = p;
            Recipient = new Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id();
