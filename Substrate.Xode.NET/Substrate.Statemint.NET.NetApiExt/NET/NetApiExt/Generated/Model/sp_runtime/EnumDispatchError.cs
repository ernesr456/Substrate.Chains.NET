...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime
{
    ...
    public sealed class EnumDispatchError : BaseEnumRust<DispatchError>
    {
        ...
        public EnumDispatchError()
        {
				...
				AddTypeDecoder<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.ModuleError>(DispatchError.Module);
				...
				AddTypeDecoder<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.EnumTokenError>(DispatchError.Token);
				AddTypeDecoder<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_arithmetic.EnumArithmeticError>(DispatchError.Arithmetic);
				AddTypeDecoder<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_runtime.EnumTransactionalError>(DispatchError.Transactional);
