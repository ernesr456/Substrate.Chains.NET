...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.staging_xcm_executor.traits.asset_transfer
{
    ...
    public sealed class EnumTransferType : BaseEnumRust<TransferType>
    {
        ...
        public EnumTransferType()
        {
				...
				AddTypeDecoder<Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation>(TransferType.RemoteReserve);
        }
    }
}
