...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_scheduler
{
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.Arr32U8> MaybeId { get; set; }
        /// <summary>
        /// >> priority
        /// </summary>
        ...
        /// >> call
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call { get; set; }
        /// <summary>
        /// >> maybe_periodic
        /// </summary>
        ...
        /// >> origin
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.EnumOriginCaller Origin { get; set; }
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Substrate.Statemint.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new Substrate.Statemint.NET.NetApiExt.Generated.Model.ajuna_runtime.EnumOriginCaller();
