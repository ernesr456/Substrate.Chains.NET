...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config
{
    ...
    public sealed class FreemintTransferConfig : BaseType
    {
        ...
        /// >> mode
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config.EnumFreeMintTransferMode Mode { get; set; }
        /// <summary>
        ...
        {
            var start = p;
            Mode = new Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config.EnumFreeMintTransferMode();
