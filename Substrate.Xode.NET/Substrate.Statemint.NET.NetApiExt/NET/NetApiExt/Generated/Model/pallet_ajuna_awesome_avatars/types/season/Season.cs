...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.season
{
    ...
    public sealed class Season : BaseType
    {
        ...
        /// >> tiers
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 Tiers { get; set; }
        /// <summary>
        /// >> single_mint_probs
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 SingleMintProbs { get; set; }
        /// <summary>
        /// >> batch_mint_probs
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 BatchMintProbs { get; set; }
        /// <summary>
        /// >> base_prob
        /// </summary>
        ...
        /// >> fee
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee Fee { get; set; }
        /// <summary>
        /// >> mint_logic
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration MintLogic { get; set; }
        /// <summary>
        /// >> forge_logic
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration ForgeLogic { get; set; }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Tiers = new Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            Tiers.Decode(byteArray, ref p);
            SingleMintProbs = new Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            SingleMintProbs.Decode(byteArray, ref p);
            BatchMintProbs = new Substrate.Statemint.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            ...
            Fee = new Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee();
            Fee.Decode(byteArray, ref p);
            MintLogic = new Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
            MintLogic.Decode(byteArray, ref p);
            ForgeLogic = new Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
